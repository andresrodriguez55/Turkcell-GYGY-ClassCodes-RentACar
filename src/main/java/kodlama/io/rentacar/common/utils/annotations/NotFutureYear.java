...
public @interface NotFutureYear
{
    ...
    //? Farklı kullanıcı gruplarına özelleştirilmiş işlemler ve özellikler tanımlamak için kullanılır
    Class<?>[] groups() default {};
    //? veri transfer nesnelerinde belirli bir grubun mesajları taşımak için kullanılır
